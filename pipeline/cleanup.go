...
// CleanupExpiredFiles removes files in data/ older than the configured expiry days.
// Only cleans known runtime file patterns: push_history_*.jsonl, tagged_cache_*.jsonl, digest_*.md.
